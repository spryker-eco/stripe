 ...
 */
class StripeCreditCardSubForm extends AbstractSubFormType implements SubFormInterface, SubFormProviderNameInterface
{
    ...
    {
        return PaymentTransfer::STRIPE_CREDIT_CARD;
    }
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'data_class' => StripeCreditCardTransfer::class,
        ]);
    }
    ...
    {
        return StripeConfig::PAYMENT_PROVIDER_NAME . DIRECTORY_SEPARATOR . static::CREDIT_CARD;
    }
}
